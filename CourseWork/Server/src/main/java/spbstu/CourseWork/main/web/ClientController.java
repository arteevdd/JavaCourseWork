...
public class ClientController {
    ...
    public ResponseEntity<Client> add(@RequestBody Map<String, String> json){
        ...
        String passportSeria = json.get("passportSeria");
        String passportNum = json.get("passportNum");
        Client client = new Client(firstName, lastName, fatherName, passportSeria, passportNum);
